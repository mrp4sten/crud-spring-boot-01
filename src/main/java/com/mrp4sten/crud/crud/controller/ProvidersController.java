...
import com.mrp4sten.crud.crud.service.impl.ProviderServiceImpl;

@RestController
@RequestMapping(value = "/provider")
public class ProvidersController {

    @Autowired ProviderServiceImpl service;
    ...
    public ResponseEntity add(@RequestBody ProviderDto provider) {
        return new ResponseEntity(service.add(provider), HttpStatus.OK);
    }
